...
const gearItems = [
  ...
  { id: 'phantom_cloak', name: 'Phantom Cloak', icon: '👁️', desc: 'A veil against lost momentum.', perk: 'Offline mode preserves combo streak for 1 extra day', stat: 'offline_combo_grace', value: 1, unlockCondition: 'Use offline mode 3 times' },
  ...
  { id: 'arcane_scroll', name: 'Arcane Scroll', icon: '📜', desc: 'Its runes record every PR in full.', perk: 'History tab shows full set details including PRs', stat: 'history_detail_unlock', value: 1, unlockCondition: 'Log 100 sets total' },
